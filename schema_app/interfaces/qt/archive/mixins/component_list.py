...
class ComponentListMixin:
    ...
    def add_component_brick(self):
        ...
        from schema_app.interfaces.qt.add_component_dialog import AddComponentDialog
    ...
    def _open_ui_metadata_dialog(self, brick_id: str):
        ...
        if brick_id not in self.current_schema.component_brick_ids:
            ...
            return
        from schema_app.interfaces.qt.ui_metadata_panel_dialog import UIMetadataPanelDialog
