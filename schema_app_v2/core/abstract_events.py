#!/usr/bin/env python3
"""
Abstract Event System for Schema App Multi-Client Support
...
class EventType(Enum):
    """Standardized event types for Schema App"""
...
# Convenience functions for creating common schema events
def create_schema_created_event(schema_data: Dict[str, Any], session_id: str) -> Event:
    """Create a schema created event"""
    return Event(
...
def create_schema_updated_event(schema_data: Dict[str, Any], session_id: str) -> Event:
    """Create a schema updated event"""
    return Event(
...
def create_component_added_event(component_data: Dict[str, Any], session_id: str) -> Event:
