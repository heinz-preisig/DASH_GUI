...
|__ refactored_gui.py        # Qt GUI frontend
...
- `brick_app_v2/refactored_gui.py` - Qt GUI frontend
- `brick_app_v2/gui_components.py` - Dialog components (load from .ui files)
